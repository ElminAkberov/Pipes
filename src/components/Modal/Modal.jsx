...
const Modal = ({ img, header, body, button,className }) => {
  return (
    <div className={`${className} text-center max-w-[470px] p-[40px] rounded-2xl bg-white shadow-[0px_4px_14px_0px_#00000024] z-30`}>
